...
--
-- Table structure for table `AdminTime`
--
...
CREATE TABLE `AdminTime` (
  `admintime_id` int(10) NOT NULL DEFAULT '0',
  `admintype_id` smallint(5) DEFAULT NULL,
  `appr` tinyint(1) DEFAULT NULL,
  `appr_date` datetime DEFAULT NULL,
  `appr_user` varchar(50) DEFAULT NULL,
  ...
  `rev_timein` datetime DEFAULT NULL,
  `rev_timeout` datetime DEFAULT NULL,
  `reviewer_comment` varchar(255) DEFAULT NULL,
  `timein` datetime DEFAULT NULL,
  `timeout` datetime DEFAULT NULL,
  `transfer_date` datetime DEFAULT NULL,
  `updatedby_emp_id` smallint(5) DEFAULT NULL,
  PRIMARY KEY (`admintime_id`),
  KEY `IX_AdminTime` (`timein`),
  KEY `IX_AdminTime_2` (`rev_timein`),
  KEY `IX_AdminTime_3` (`admintype_id`)
...
-- Dump completed on 2017-01-31 11:29:30
