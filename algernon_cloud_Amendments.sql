...
CREATE TABLE `Amendments` (
  `amendment_id` int(10) NOT NULL DEFAULT '0',
  `amendment_text` varchar(500) DEFAULT NULL,
  `amendmentstatus_id` int(10) DEFAULT NULL,
  `amendmenttype_id` int(10) DEFAULT NULL,
  `client_id` int(10) DEFAULT NULL,
  `date_created` datetime DEFAULT NULL,
  `date_updated` datetime DEFAULT NULL,
  `linkingrecord_id` int(10) DEFAULT NULL,
...
-- Dump completed on 2017-01-31 11:29:42
