...
CREATE TABLE `AppVersion` (
  `file_change` tinyint(1) DEFAULT NULL,
  `file_version_string` varchar(10) DEFAULT NULL,
  `for_release` tinyint(1) DEFAULT NULL,
  `schema_change` tinyint(1) DEFAULT NULL,
  `version_date` datetime DEFAULT NULL,
  `version_id` int(10) NOT NULL DEFAULT '0',
  `version_string` varchar(20) DEFAULT NULL,
