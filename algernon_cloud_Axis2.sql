...
--
-- Table structure for table `Axis2`
--

DROP TABLE IF EXISTS `Axis2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Axis2` (
  `axis2_id` smallint(5) NOT NULL DEFAULT '0',
  `axis_2_code` varchar(6) DEFAULT NULL,
  `axis_2_desc` varchar(150) DEFAULT NULL,
  `axis_2_short_desc` varchar(25) DEFAULT NULL,
  ...
  PRIMARY KEY (`axis2_id`),
  KEY `IX_Axis2_code` (`axis_2_code`),
  KEY `IX_Axis2_code_desc` (`axis_2_code`,`axis_2_desc`)
