...
--
-- Table structure for table `BI_LOGGING`
--

DROP TABLE IF EXISTS `BI_LOGGING`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BI_LOGGING` (
  `EventCode` longtext,
  `EventData` longtext,
  `EventId` int(10) DEFAULT NULL,
  `EventTypeCode` longtext,
  `PartnerID` int(10) DEFAULT NULL,
  `SessionId` longtext,
  `eventTime_GMT` varchar(46) DEFAULT NULL,
...
-- Dump completed on 2017-01-31 11:29:34
