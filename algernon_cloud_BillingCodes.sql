...
DROP TABLE IF EXISTS `BillingCodes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BillingCodes` (
  `billingcode` varchar(30) NOT NULL DEFAULT '',
  `billingcodetype` varchar(2) NOT NULL DEFAULT '',
  `date_updated` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `updatedby_emp_id` smallint(5) DEFAULT NULL,
  PRIMARY KEY (`billingcode`,`billingcodetype`)
