...
--
-- Table structure for table `ClientEpisodeTablesView`
--

DROP TABLE IF EXISTS `ClientEpisodeTablesView`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ClientEpisodeTablesView` (
  `admission_date` datetime DEFAULT NULL,
  `admission_source` char(1) DEFAULT NULL,
  `admission_type` char(1) DEFAULT NULL,
  ...
  `patient_status` char(2) DEFAULT NULL,
...
-- Dump completed on 2017-01-31 11:29:43
