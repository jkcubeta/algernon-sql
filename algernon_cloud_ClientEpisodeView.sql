...
--
-- Table structure for table `ClientEpisodeView`
--

DROP TABLE IF EXISTS `ClientEpisodeView`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ClientEpisodeView` (
  `admission_date` datetime DEFAULT NULL,
  `admission_source` varchar(200) DEFAULT NULL,
  `admission_type` varchar(200) DEFAULT NULL,
  `episode_id` int(10) DEFAULT NULL,
  `episode_start_date` datetime DEFAULT NULL,
  `intake_date` datetime DEFAULT NULL,
  `length_of_stay` int(10) DEFAULT NULL,
  `patient_class` varchar(200) DEFAULT NULL,
  `patient_status` varchar(100) DEFAULT NULL,
  `program_discharge_date` datetime DEFAULT NULL,
  `reason_for_discharge` varchar(100) DEFAULT NULL,
