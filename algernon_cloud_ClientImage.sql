...
CREATE TABLE `ClientImage` (
  ...
  `client_image` varbinary(500) DEFAULT NULL,
  `clientimage_id` int(10) NOT NULL DEFAULT '0',
  `date_created` datetime DEFAULT NULL,
  `date_updated` datetime DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT NULL,
  `deleted_by_emp_id` int(10) DEFAULT NULL,
  `deleted_on` datetime DEFAULT NULL,
  `updatedby_emp_id` smallint(5) DEFAULT NULL,
  PRIMARY KEY (`clientimage_id`),
  KEY `IX_ClientImage` (`client_id`,`date_created`)
...
-- Dump completed on 2017-01-31 11:29:41
