...
--
-- Table structure for table `ClientInsurance`
--

DROP TABLE IF EXISTS `ClientInsurance`;
...
CREATE TABLE `ClientInsurance` (
  ...
  `card2_file_id` int(10) DEFAULT NULL,
  `card_file_id` int(10) DEFAULT NULL,
  ...
  PRIMARY KEY (`clientins_id`),
  KEY `IX_ClientInsurance_billing_ord` (`billing_ord`),
  KEY `IX_ClientInsurance_client` (`client_id`),
  KEY `IX_ClientInsurance_client_payer_dates` (`billing_ord`,`client_id`,`deleted`,`end_date`,`inactive`,`ins_id`,`payer_id`,`start_date`),
  KEY `IX_ClientInsurance_end_date` (`end_date`),
  KEY `IX_ClientInsurance_ins` (`ins_id`),
  KEY `IX_ClientInsurance_payer` (`payer_id`),
  KEY `IX_ClientInsurance_start_date` (`start_date`)
...
-- Dump completed on 2017-01-31 11:30:24
